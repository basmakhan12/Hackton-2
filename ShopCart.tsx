  ...
  return (
    ...
    <div className='w-[1920px]'>
      ...
      <div className="w-full h-auto py-4 bg-white flex flex-col md:flex-row justify-between items-center px-4 md:px-12 lg:px-24">
        ...
        <li>
          <Link href="http://localhost:3000/ShopCart">ShopCart</Link>
        </li>
        <li>
    ...
    <div className='w-[1609px] h-[632.89px] mt-[174px] ml-[179px]'>
      <div className=' w-[1100px] h-[547.89px] bg-[#ffffff]'>
        <img src="/image/Auto.svg" alt="Auto" />
        <img src="/image/Layout.svg" alt="Layout" />
        </div>
        </div>
      <div className='flex w-[350.67px] h-[295px] mt-[28px] ml-[1100px]'>right
        <img src="/image/Frame.svg" alt="Frame" />
      </div>
